export default {
  ...
  'auth.resetEmailDesc': 'أرسلنا رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني. تحقق من صندوق الوارد.',
  'auth.backToSignIn': 'العودة إلى تسجيل الدخول',
  'auth.orDivider': 'أو سجّل الدخول بدون كلمة مرور',
  'auth.sendMagicLink': 'إرسال رابط سحري',
  'auth.magicLinkSent': 'تم إرسال الرابط السحري! تحقق من بريدك الإلكتروني لتسجيل الدخول.',
