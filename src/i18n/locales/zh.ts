export default {
  ...
  'auth.forgotPasswordDesc': '输入您的电子邮件，我们将向您发送重置链接。',
  'auth.sendResetLink': '发送重置链接',
  'auth.resetEmailSent': '请查看您的邮箱！',
  'auth.resetEmailDesc': '我们已向您的邮箱发送了密码重置链接，请查收。',
  'auth.backToSignIn': '返回登录',
  'auth.orDivider': '或无密码登录',
  'auth.sendMagicLink': '发送魔法链接',
  'auth.magicLinkSent': '魔法链接已发送！请查看您的邮箱以登录。',
  'auth.noAccount': '没有账户？',
