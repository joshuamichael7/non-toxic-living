export default {
  ...
  'auth.resetEmailSent': '이메일을 확인하세요!',
  'auth.resetEmailDesc': '비밀번호 재설정 링크를 이메일로 보냈습니다. 받은 편지함을 확인해주세요.',
  'auth.backToSignIn': '로그인으로 돌아가기',
  'auth.orDivider': '또는 비밀번호 없이 로그인',
  'auth.sendMagicLink': '매직 링크 보내기',
  'auth.magicLinkSent': '매직 링크가 전송되었습니다! 이메일을 확인하여 로그인하세요.',
